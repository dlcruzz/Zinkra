      ...
      <div className="max-w-3xl mx-auto px-6">
        <div className="text-center mb-14">
          ...
          >
            ...
            <span style={{ color: '#15C45A' }}>para o seu negocio.</span>
          </h2>
          <p className="mt-4 text-[16px]" style={{ color: '#4A5550' }}>
            Cada plano construido do zero — sem template, sem enrolacao.
          </p>
        </div>
        <Services standalone />
      </div>
    ...
    >
      ...
      <div ref={ref} className="max-w-2xl mx-auto px-6 relative opacity-0">
        ...
        <p className="text-[17px] mb-10 leading-[1.75]" style={{ color: '#5A7A65' }}>
          Marque uma conversa gratuita. A gente entende seu negocio, apresenta as solucoes certas e te da um orcamento sem compromisso.
        </p>
        <a
        ...
        <div className="flex items-center justify-center gap-6 flex-wrap">
          {['Sem compromisso', 'Orcamento gratuito', 'Respondemos em ate 2h'].map(t => (
