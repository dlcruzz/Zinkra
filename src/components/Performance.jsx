        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div ref={textRef} className="opacity-0">
            ...
            <p className="text-[16px] leading-[1.8] mb-6" style={{ color: '#4A5550' }}>
              Desenvolvemos sites rapidos e otimizados, atingindo notas de 90 ou mais no PageSpeed. Garantimos rapidez tanto em dispositivos moveis quanto em desktops, proporcionando uma experiencia de usuario superior.
            </p>
            <p className="text-[16px] leading-[1.8] mb-10" style={{ color: '#4A5550' }}>
              Sites lentos perdem clientes. Cada segundo a mais de carregamento reduz a taxa de conversao. A Zinkra entrega performance como padrao — nao como opcional.
            </p>
